...
Starting from the question statement, we need at least 8 lines left on the page or the question moves to next page.
...
This will get you a document looking like the one in figure \ref{min}. Note that it appears bigger for illustration purposes only.
